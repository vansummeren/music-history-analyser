...
import { BarChart2, Calendar, Cpu, FileText, LayoutDashboard, Music, Settings, ShieldCheck, X } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/logs', icon: FileText, label: 'Logs', end: false, adminOnly: true },
]
